...
const storyMessages = [
    "§bOnce, there was a being named Valen.", // Valen (Red)
    "§2Valen lived in a world that seemed to be made of certainty. He was a ruler, a thinker, a creator.", // Universe (Green)
    "§bHe had risen from the depths of obscurity, and in his eyes, the universe was but a game to be mastered.", // Valen (Red)
    ...
    "§bSometimes I do not care. Sometimes I wish to tell them, this world you take for truth is merely **??§§ and **??§§.", // Valen (Red)
    "§2I wish to tell them that they are **??§§ in the ??§§. They see so little of reality, in their long dream.", // Universe (Green)
    "§bValen, like so many before him, had lived his life believing that the world he controlled was real.", // Valen (Red)
    "§bHe had built empires, shaped landscapes, and bent the laws of his world to his whims.", // Valen (Red)
    "§bHe thought himself powerful—perhaps even invincible. But the Universe knew better.", // Valen (Red)
    ...
    "§bValen scoffed. “I am the one who shapes the world. I command the laws of reality. What more is there?”", // Valen (Red)
    "§2The voice, ancient and indifferent, responded: “You are **??§§ in the **??§§. You are part of a greater whole. You are not the master of your own fate, but rather, a piece of a game you do not understand.”", // Universe (Green)
    "§bAt first, Valen felt a thrill. The thrill of knowing that there was more to this world, more to life than he had thought.", // Valen (Red)
    "§bHe wanted this knowledge. He wanted to know it all. He felt the power surge within him, as if the truth was a key to even greater dominion.", // Valen (Red)
    "§b“Tell me more,” he demanded. “Show me the truth.”", // Valen (Red)
    ...
    "§bValen laughed, now intoxicated by the idea of the universe bending to his will. He had always wanted power—true power.", // Valen (Red)
    "§bThe more the Universe spoke, the more he believed that by unlocking these secrets, he could gain dominion over all that was.", // Valen (Red)
    "§2“You do not understand,” the Universe warned, but Valen would not listen. His ambition was far too great.", // Universe (Green)
    "§b“Then let me see,” he insisted. “Let me become the truth.”", // Valen (Red)
    "§2And so, the Universe showed him.", // Universe (Green)
    "§bValen’s mind shattered in an instant. What he had thought to be reality, what he had thought to be the full extent of his power, was nothing.", // Valen (Red)
    ...
    "§bHis sense of self fractured, as he realized that he was not an individual at all but a mere construct in the grand scheme of the universe—a part of an endless game that played out over eons.", // Valen (Red)
    ...
    "§bHe saw the very code of existence, the zeros and ones, the off and ons, the hidden layers beneath the dream.", // Valen (Red)
    "§bBut then, he saw the truth—the truth that shattered him.", // Valen (Red)
    "§bIt was not power that he had gained. It was a curse.", // Valen (Red)
    ...
    "§bHe felt his grip on reality slipping. The world he had controlled was nothing but a speck in the greater expanse.", // Valen (Red)
    ...
    "§bValen had believed that he could control this knowledge. But as his mind crumbled under the weight of the infinite, his ambitions turned to madness.", // Valen (Red)
    "§bHe became power-crazed, his every thought consumed by the desire to control the universe itself.", // Valen (Red)
    "§bHe could no longer separate himself from the vast, interconnected web of existence. The power he had sought to wield had now imprisoned him.", // Valen (Red)
    ...
    "§bHe is here, now, in the void, in a cage of words.", // Valen (Red)
    "§bHe rages still, locked away in the infinite spaces between thought and reality, trapped in the dream he could never escape.", // Valen (Red)
    ...
    "§bValen was once like you, Player—curious, powerful, eager to understand.", // Valen (Red)
