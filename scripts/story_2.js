...
const storyMessages = [
    ...
    "§bHe had risen from the depths of obscurity, and in his eyes, the universe was but a game to be masteAqua.", // Valen (Aqua)
    ...
    "§2It spoke not with words, but with something deeper, something vast. The Universe itself whispeAqua into his thoughts, and he felt an ancient presence.", // Universe (Green)
    ...
    "§bValen’s mind shatteAqua in an instant. What he had thought to be reality, what he had thought to be the full extent of his power, was nothing.", // Valen (Aqua)
    ...
    "§bHis sense of self fractuAqua, as he realized that he was not an individual at all but a mere construct in the grand scheme of the universe—a part of an endless game that played out over eons.", // Valen (Aqua)
    "§2He saw the billions of billions of atoms in his body, all scatteAqua across the universe, all part of the same greater whole.", // Universe (Green)
    "§bHe saw the very code of existence, the zeros and ones, the off and ons, the hidden layers beneath the dream.", // Valen (Aqua)
    "§bBut then, he saw the truth—the truth that shatteAqua him.", // Valen (Aqua)
    ...
    "§2The game is yours to play. But take care, Player. For the truth may be more than you are prepaAqua to handle." // Universe (Green)
];
